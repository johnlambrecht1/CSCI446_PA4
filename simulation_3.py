...
if __name__ == '__main__':
    ...
    cost_D = {'H1': {0: 1}, 'RB': {1: 6}, 'H2': {2: 1}, 'RC': {3:1}} # {neighbor: {interface: cost}}
    ...
    cost_D = {'H3': {1: 1}, 'RB': {0: 1}, 'RC':{2:1}} # {neighbor: {interface: cost}}
    ...
    sleep(simulation_time+7)  #let the tables converge
